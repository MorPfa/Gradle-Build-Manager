...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxHealthLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.health.services
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxHealthServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxHealthServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for client (androidx.health:health-services-client)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class AndroidxWearLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Returns the group of libraries at androidx.wear.compose
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxWearComposeLibraryAccessors extends SubDependencyFactory {
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for material (androidx.wear.compose:compose-material3)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
        ...
        /**
         * Returns the group of libraries at androidx.wear.compose.ui
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxWearComposeUiLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxWearComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for tooling (androidx.wear.compose:compose-ui-tooling)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: projectApplicationId (your.app)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final YourappPluginAccessors paccForYourappPluginAccessors = new YourappPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.yourapp
         */
        public YourappPluginAccessors getYourapp() {
            return paccForYourappPluginAccessors;
        }
    ...
    public static class YourappPluginAccessors extends PluginFactory {
        private final YourappAndroidPluginAccessors paccForYourappAndroidPluginAccessors = new YourappAndroidPluginAccessors(providers, config);
        private final YourappJvmPluginAccessors paccForYourappJvmPluginAccessors = new YourappJvmPluginAccessors(providers, config);

        public YourappPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of plugins at plugins.yourapp.android
         */
        public YourappAndroidPluginAccessors getAndroid() {
            return paccForYourappAndroidPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.yourapp.jvm
         */
        public YourappJvmPluginAccessors getJvm() {
            return paccForYourappJvmPluginAccessors;
        }

    }

    public static class YourappAndroidPluginAccessors extends PluginFactory {
        private final YourappAndroidApplicationPluginAccessors paccForYourappAndroidApplicationPluginAccessors = new YourappAndroidApplicationPluginAccessors(providers, config);
        private final YourappAndroidDynamicPluginAccessors paccForYourappAndroidDynamicPluginAccessors = new YourappAndroidDynamicPluginAccessors(providers, config);
        private final YourappAndroidFeaturePluginAccessors paccForYourappAndroidFeaturePluginAccessors = new YourappAndroidFeaturePluginAccessors(providers, config);
        private final YourappAndroidLibraryPluginAccessors paccForYourappAndroidLibraryPluginAccessors = new YourappAndroidLibraryPluginAccessors(providers, config);

        public YourappAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.room to the plugin id 'yourapp.android.room'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getRoom() { return createPlugin("yourapp.android.room"); }

        /**
         * Returns the group of plugins at plugins.yourapp.android.application
         */
        public YourappAndroidApplicationPluginAccessors getApplication() {
            return paccForYourappAndroidApplicationPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.yourapp.android.dynamic
         */
        public YourappAndroidDynamicPluginAccessors getDynamic() {
            return paccForYourappAndroidDynamicPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.yourapp.android.feature
         */
        public YourappAndroidFeaturePluginAccessors getFeature() {
            return paccForYourappAndroidFeaturePluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.yourapp.android.library
         */
        public YourappAndroidLibraryPluginAccessors getLibrary() {
            return paccForYourappAndroidLibraryPluginAccessors;
        }

    }

    public static class YourappAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        private final YourappAndroidApplicationWearPluginAccessors paccForYourappAndroidApplicationWearPluginAccessors = new YourappAndroidApplicationWearPluginAccessors(providers, config);

        public YourappAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.application to the plugin id 'yourapp.android.application'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("yourapp.android.application"); }

            /**
             * Creates a plugin provider for yourapp.android.application.compose to the plugin id 'yourapp.android.application.compose'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("yourapp.android.application.compose"); }

        /**
         * Returns the group of plugins at plugins.yourapp.android.application.wear
         */
        public YourappAndroidApplicationWearPluginAccessors getWear() {
            return paccForYourappAndroidApplicationWearPluginAccessors;
        }

    }

    public static class YourappAndroidApplicationWearPluginAccessors extends PluginFactory {

        public YourappAndroidApplicationWearPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.application.wear.compose to the plugin id 'yourapp.android.application.wear.compose'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("yourapp.android.application.wear.compose"); }

    }

    public static class YourappAndroidDynamicPluginAccessors extends PluginFactory {

        public YourappAndroidDynamicPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.dynamic.feature to the plugin id 'yourapp.android.dynamic.feature'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFeature() { return createPlugin("yourapp.android.dynamic.feature"); }

    }

    public static class YourappAndroidFeaturePluginAccessors extends PluginFactory {

        public YourappAndroidFeaturePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.feature.ui to the plugin id 'yourapp.android.feature.ui'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getUi() { return createPlugin("yourapp.android.feature.ui"); }

    }

    public static class YourappAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public YourappAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.android.library to the plugin id 'yourapp.android.library'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("yourapp.android.library"); }

            /**
             * Creates a plugin provider for yourapp.android.library.compose to the plugin id 'yourapp.android.library.compose'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("yourapp.android.library.compose"); }

    }

    public static class YourappJvmPluginAccessors extends PluginFactory {

        public YourappJvmPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for yourapp.jvm.ktor to the plugin id 'yourapp.jvm.ktor'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getKtor() { return createPlugin("yourapp.jvm.ktor"); }

            /**
             * Creates a plugin provider for yourapp.jvm.library to the plugin id 'yourapp.jvm.library'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getLibrary() { return createPlugin("yourapp.jvm.library"); }
