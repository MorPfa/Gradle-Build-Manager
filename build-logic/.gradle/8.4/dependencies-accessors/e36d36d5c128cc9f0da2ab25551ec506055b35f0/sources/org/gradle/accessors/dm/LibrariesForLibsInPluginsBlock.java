...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class RunbuddyAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        private final RunbuddyAndroidApplicationWearPluginAccessors paccForRunbuddyAndroidApplicationWearPluginAccessors = new RunbuddyAndroidApplicationWearPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.runbuddy.android.application.wear
         */
        public RunbuddyAndroidApplicationWearPluginAccessors getWear() {
            return paccForRunbuddyAndroidApplicationWearPluginAccessors;
        }

    }

    public static class RunbuddyAndroidApplicationWearPluginAccessors extends PluginFactory {

        public RunbuddyAndroidApplicationWearPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for runbuddy.android.application.wear.compose to the plugin id 'runbuddy.android.application.wear.compose'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("runbuddy.android.application.wear.compose"); }
